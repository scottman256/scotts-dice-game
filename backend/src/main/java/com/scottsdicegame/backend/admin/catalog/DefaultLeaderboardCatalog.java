package com.scottsdicegame.backend.admin.catalog;

import java.util.List;
import java.util.UUID;

public final class DefaultLeaderboardCatalog {

    public static final List<DefaultScore> SCORES = List.of(
